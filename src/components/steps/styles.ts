...
export const GetAddressStepStyle: SxProps = {
  ...
  '& .partner-card': {
    ...
    '& .partner-card-logo': {
      ...
      mb: 2.25,
      overflow: 'hidden',
      '& img': { width: '100%', height: '100%', objectFit: 'cover', transform: 'scale(1.5)' },
    },
  ...
  '& .hd-banner': {
    ...
    boxShadow: REF.shadow,
    mt: { xs: 3, md: 4 },
    '& .hd-banner-caption': { position: 'absolute', left: 20, bottom: 20, right: 20, display: 'flex' },
    '& .hd-tag': {
      display: 'inline-flex',
      alignItems: 'center',
      gap: 1,
      ...
      '&::before': {
        ...
        borderRadius: '50%',
        background: REF.orange,
        boxShadow: '0 0 0 4px rgba(233, 107, 51, 0.25)',
      },
    },
  },
